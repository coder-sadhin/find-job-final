    ...
    return (
        <div >
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3'>
                <a href={Featured?.resume} target='_blank' className="card w-full bg-base-content shadow-xl">
                ...
                <a href={Featured?.portfolio} target='_blank' className="card w-full bg-base-content shadow-xl">
                    <figure className="px-10 pt-10">
                ...
                <a href={Featured?.github} target='_blank' className="card w-full bg-base-content shadow-xl">
                    <figure className="px-10 pt-10">
