...
const PricingPlan = () => {
    ...
    const openCheckOut = (pack, amonunt) => {
        const buyPack = {
            pack,
            amonunt
        }
                ...
                <div className='grid mt-16 gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-white '>
                    <div
                        ...
                        <div className='text-center my-4'>
                            ...
                            <div className='p-6'>
                                <button onClick={() => openCheckOut("Basic", 2.44)} className="btn btn-outline btn-warning p-4">Choose Plan</button>
                            </div>
                        </div>
                    ...
                    <div style={{
                        ...
                        <div className='text-center my-4'>
                            ...
                            <div className='p-6'>
                                <button onClick={() => openCheckOut("Medium", 4.99)} className="btn btn-outline btn-warning p-4">Choose Plan</button>
                            </div>
                        </div>
                        <div className='text-center'>
                    ...
                    <div
                        ...
                        <div className='text-center my-4'>
                            ...
                            <div className='p-6'>
                                <button onClick={() => openCheckOut("Enterprise", 10.99)} className="btn btn-outline btn-warning p-4">Choose Plan</button>
                            </div>
                        </div>
                        <div className='text-center'>
                            <p className='flex gap-2 mb-2'> <FaRegCheckCircle className='bg-green-600 rounded-full' /> <small>unlimited products</small></p>
